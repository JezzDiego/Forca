var words = ['olho', 'cebola', 'computador', 'mesa', 'bolsa', 'celular', 'caneta', 'copo', 'mouse', 'teclado', 'pneumoultramicroscopicossilicovulcanoconiotico'];
var choosenWord;
var hiddenWord = "";
var triedLetters = [];
var correctLetters = [];
...
function drawImage(){
    ...
    switch(errors){
        ...
        case 6:
            ...
            mensagem.innerText = "Você perdeu já tio!";
            break
    }
}
